...
public class Day16_Annotations {
    ...
    @Before and @After : 10 before and after annotations. The are used to control FLOW and DESIGN of the testsOW and DESIGN of the tests are used to control FLOW and DESIGN of the tests
    ...
    We should use priority when there are multiply
     */
    @BeforeSuite
